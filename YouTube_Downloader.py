...
# yt-dlpのオプションを設定
option = {
        'outtmpl': "/Users/ryo/Downloads/YouTube/%(title)s",
...
# 入出力パスを指定
input_path = os.path.join("/Users/ryo/Downloads/YouTube", input_title)
output_path = os.path.join("/Users/ryo/Downloads/YouTube", output_title)
